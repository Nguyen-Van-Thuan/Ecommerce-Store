                      ...
                      <div class="card product-item border-0 mb-4">
                          <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                              @if ($item->images->count() > 0 && $item->images->first())
                                  <img src="{{ asset('upload/' . $item->images->first()->url) }}" width="100px"
                                      height="100px" alt="" class="img-fluid w-100">
                              @else
                                  <img src="{{ asset('upload/default.png') }}" width="100px" height="100px"
                          ...
                          <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                              ...
                              <div class="d-flex justify-content-center">
                                  ...
                                  <h6 class="text-muted ml-2"><del>{{ $item->price }} VND</del></h6>
                              </div>
                          </div>
